...
assert.doesNotMatch(panel, /image\(hallar_m,/, 'el panel todavía muestra las letras rasterizadas');
...
assert.match(html, /barra_sup\.js\?v=20260815-3/, 'el navegador descarga las letras actualizadas');
